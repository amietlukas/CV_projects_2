...
def train(
    train_loader, model, criterion, optimizer, epoch, output_dir, writer_dict, args
):
        ...
        for i, (input, target) in enumerate(val_loader):
            ...
            if i % args.frequent == 0:
                ...
                if writer_dict:
                    ...
                    writer.add_image(
                        "input_image", input_image, global_steps, dataformats="CHW"
                    )
                    writer.add_image(
                        "result_vis", output_vis, global_steps, dataformats="HWC"
                    )
                    writer.add_image(
                        "gt_mask", target_image, global_steps, dataformats="HWC"
                    )
